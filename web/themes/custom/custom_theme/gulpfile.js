...
gulp.task("build:modernizr", (callback) => {
  runSequence(
    ["build:javascripts", "build:styles"],
    "clean:modernizr",
    "process:modernizr",
    callback,
  );
...
gulp.task("process:styles", () => {
  return gulp
    .src(compileConfig.settings.styles)
...
gulp.task("process:javascripts", () => {
  return gulp
    .src(compileConfig.settings.javascripts)
...
gulp.task("process:fonts", () => {
  return gulp.src(compileConfig.settings.fonts).pipe(gulp.dest("dist/fonts"));
});
